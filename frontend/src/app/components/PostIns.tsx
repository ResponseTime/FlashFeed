...
export default function PostIns() {
    return (
        <>
            <div className="postw flex md:gap-3 border-b-2 border-gray-900 md:m-5 p-2 h-20 items-center">
            ...
            <div className="actions flex flex-row md:px-10 justify-between p-2">
