...
export default function Right() {
    ...
    return (
        <div className="w-full flex-col hidden lg:block ">
            ...
            <div className="what m-3 bg-[#16181c] hidden w-64 lg:block space-y-3 rounded-xl py-3">
            ...
            <div className="who m-3 bg-[#16181c] hidden w-64  lg:block space-y-3 rounded-xl py-3">
                <h2 className="px-3 font-bold text-lg">
                    Who to Follow
                </h2>
                {follow.map((n: any) => {
